  ...
  return (
    ...
    >
      <fieldset className="col-span-1">
        <label
          className={"text-base"}
          htmlFor={`section-${section?.layout_metadata.displayId}-structured-prompt`}
        >
          Prompt
        </label>
        <TextArea
          id={`section-${section?.layout_metadata.displayId}-structured-prompt`}
          name={`section-${section?.layout_metadata.displayId}-structured-prompt`}
          rows={inputsUuid !== "" ? "5" : "2"}
          placeholder="What would you like to know?"
          className="mt-3 rounded-xs bg-third border-0 dark:bg-[#484954] dark:text-white w-full"
